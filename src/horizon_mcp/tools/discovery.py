...
_COVERAGE: dict = {
    "tools": {
        ...
        "config": [
            ...
            "get_global_policies — USB, clipboard, and multimedia policies",
    ...
    "not_yet_supported": [
        ...
        "Session-level reset/restart actions (POST /inventory/v1/sessions/action/reset|restart)",
        "Machine user assignment for dedicated desktops (assign-users, unassign-users)",
        "Desktop pool enable/disable and enable/disable-provisioning",
