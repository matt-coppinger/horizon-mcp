...
_COVERAGE: dict = {
    "tools": {
        ...
        "inventory": [
            ...
            "delete_desktop_pool — delete pool and all machines (user confirms in the client)",
            ...
            "delete_rdsh_farm — delete farm and all servers (user confirms in the client)",
            "rdsh_farm_action — enable or disable an RDS farm (get-then-update round trip, "
            "verified live)",
            ...
            "delete_application_pool — unpublish an application pool (user confirms in the client)",
        ...
        "config": [
            ...
            "list_image_management — IM streams, or a stream's versions/tags (pass resource, plus stream_id for versions/tags)",
        ...
        "resource_discovery_for_pool_creation": [
            ...
            "list_network_interface_cards(vcenter_id, base_vm_id | vm_template_id) — NIC IDs for pool NIC config",
